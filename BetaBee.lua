...
local information = hometab:CreateSection("信息")
...
farmo:CreateToggle("Auto Sprinklers", nil, function(State) andromeda.toggles.autosprinkler = State end)
...
local farmt = farmtab:CreateSection("AFK")
farmt:CreateToggle("Auto Dispenser ⚙", nil, function(State) andromeda.toggles.autodispense = State end)
farmt:CreateToggle("Auto Booster ⚙", nil, function(State) andromeda.toggles.autoboosters = State end)
...
farmt:CreateToggle("AFK萌芽", nil, function(State) andromeda.toggles.farmsprouts = State end)
farmt:CreateToggle("AFK蘑菇", nil, function(State) andromeda.toggles.farmpuffshrooms = State end)
--farmt:CreateToggle("Farm Snowflakes ⚠️", nil, function(State) andromeda.toggles.farmsnowflakes = State end)
farmt:CreateToggle("Teleport到稀有 ⚠️", nil, function(State) andromeda.toggles.farmrares = State end)
farmt:CreateToggle("Auto Accept/Confirm Quests ⚙", nil, function(State) andromeda.toggles.autoquest = State end)
farmt:CreateToggle("Auto Do Quests (Chinese not supported) ⚙", nil, function(State) andromeda.toggles.autodoquest = State end)
...
mobkill:CreateToggle("杀死 Mondo", nil, function(State) andromeda.toggles.killmondo = State end)
...
local amks = combtab:CreateSection("自动杀怪Settings")
amks:CreateTextBox('Kill mobs after X pollen converts', 'Default = 3', true, function(Value) andromeda.vars.monstertimer = tonumber(Value) end)


local wayp = wayptab:CreateSection("地点")
wayp:CreateDropdown("农场Teleport", fieldstable, function(Option) game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").FlowerZones:FindFirstChild(Option).CFrame end)
wayp:CreateDropdown("怪物Teleport", spawnerstable, function(Option) d = game:GetService("Workspace").MonsterSpawners:FindFirstChild(Option) game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(d.Position.X, d.Position.Y+3, d.Position.Z) end)
wayp:CreateDropdown("玩具Teleport", toystable, function(Option) d = game:GetService("Workspace").Toys:FindFirstChild(Option).Platform game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(d.Position.X, d.Position.Y+3, d.Position.Z) end)
...
local miscc = misctab:CreateSection("Miscellaneous")
...
local wstoggle = miscc:CreateToggle("步行速度", nil, function(State) andromeda.toggles.loopspeed = State end) wstoggle:CreateKeybind("K", function(Key) end)
...
local misco = misctab:CreateSection("其他")
...
misco:CreateDropdown("Equip Tool", collectorstable, function(Option) local ohString1 = "Equip" local ohTable2 = { ["Mute"] = false, ["Type"] = Option, ["Category"] = "Collector" } game:GetService("ReplicatedStorage").Events.ItemPackageEvent:InvokeServer(ohString1, ohTable2) end)
misco:CreateDropdown("Generate Amulet", {"Supreme Star Amulet", "Diamond Star Amulet", "Gold Star Amulet","Silver Star Amulet","Bronze Star Amulet","月亮护身符"}, function(Option) local A_1 = Option.." Generator" local Event = game:GetService("ReplicatedStorage").Events.ToyEvent Event:FireServer(A_1) end)
misco:CreateButton("导出统计表", function() local StatCache = require(game.ReplicatedStorage.ClientStatCache)writefile("Stats_"..api.nickname..".json", StatCache:Encode()) end)


local extras = extrtab:CreateSection("Extra Features")
extras:CreateButton("Hide Nickname", function() loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/lua@main/UTILITES/nicknamespoofer.lua"))()end)
extras:CreateButton("Unlock FPS Limit", function()loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/lua@main/UTILITES/fpsboost.lua"))()end)
extras:CreateButton("Destroy Decals", function()loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/lua@main/UTILITES/destroydecals.lua"))()end)
...
local farmsettings = setttab:CreateSection("自动AFKSettings")
farmsettings:CreateTextBox("Auto Farm Walk Speed", "Default Value = 60", true, function(Value) andromeda.vars.farmspeed = Value end)
farmsettings:CreateToggle("^ Loop Farm Speed",nil, function(State) andromeda.toggles.loopfarmspeed = State end)
farmsettings:CreateToggle("Don't Walk in Wild",nil, function(State) andromeda.toggles.farmflower = State end)
farmsettings:CreateToggle("Convert Hive Balloons",nil, function(State) andromeda.toggles.convertballoons = State end)
farmsettings:CreateToggle("Don't Use Farm Tokens",nil, function(State) andromeda.toggles.donotfarmtokens = State end)
farmsettings:CreateSlider("步行速度", 0, 120, 70, false, function(Value) andromeda.vars.walkspeed = Value end)
farmsettings:CreateSlider("Jump Height", 0, 120, 70, false, function(Value) andromeda.vars.jumppower = Value end)
local raresettings = setttab:CreateSection("令牌Settings")
...
raresettings:CreateDropdown("Rares List", andromeda.rares, function(Option) end)
local dispsettings = setttab:CreateSection("Auto Dispenser和自动增压器Settings")
...
dispsettings:CreateToggle("治疗分配器", nil,  function(State) andromeda.dispensesettings.treat = not andromeda.dispensesettings.treat end)
dispsettings:CreateToggle("椰子分配器", nil,  function(State) andromeda.dispensesettings.coconut = not andromeda.dispensesettings.coconut end)
...
dispsettings:CreateToggle("山顶助推器", nil,  function(State) andromeda.dispensesettings.white = not andromeda.dispensesettings.white end)
...
andromedas:CreateButton("保存 Config", function() writefile("andromeda/BSS_"..temptable.configname..".json",game:service'HttpService':JSONEncode(andromeda)) end)
...
fieldsettings:CreateButton("Remove Field From Blacklist", function() table.remove(andromeda.blacklistedfields, api.tablefind(andromeda.blacklistedfields, temptable.blackfield)) game:GetService("CoreGui"):FindFirstChild(_G.windowname).Main:FindFirstChild("Blacklisted Fields D",true):Destroy() fieldsettings:CreateDropdown("Blacklisted Fields", andromeda.blacklistedfields, function(Option) end) end)
